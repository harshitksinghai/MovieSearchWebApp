...
const ResetPassword: React.FC<ResetPasswordProps> = ({ email, setError, setOtpMode, setAuthMode }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, actions) => {
            try {
                ...
                const response = await authApi.changePasswordAndLogin({ userId: email, password: values.password });
