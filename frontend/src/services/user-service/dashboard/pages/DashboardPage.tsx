...
import { genreChartDataFilter, lastThirtyDaysTimeWatchedFilter, ratingChartDataFilter, recentFavouritesFilter, reWatchesFilter, totalLovedTimeWatchedFilter, totalTimeWatchedFilter, totalWatchedCountFilter, yearlyTimeWatchedFilter } from "@/redux/filter/filterSlice";
            ...
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    {userDetails?.firstName
                        ? `${t('dashboard.hello')}${userDetails.firstName} ${userDetails.middleName ?? ''} ${userDetails.lastName ?? ''}`
