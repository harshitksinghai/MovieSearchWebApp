...
router.post('/getlistwithdetails', authToken_1.verifyToken, dataInTransitEncryption_1.decryptRequest, encryptResponseForRoute_1.encryptResponseForRoute, movieController_1.getMovieListWithDetails);
/**
 * @swagger
